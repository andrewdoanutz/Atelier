...
db.conn.execute("CREATE TABLE IF NOT EXISTS IMAGES (user_email TEXT, image TEXT NOT NULL, FOREIGN KEY(user_email) REFERENCES USERS(email) ON DELETE CASCADE ON UPDATE CASCADE)")
db.conn.commit()
